...
import { LayoutDashboard, FolderKanban, Bug, Bell, Activity, User, Settings } from "lucide-react";

export default function Sidebar({ open, setOpen }) {
    const navClass = ({ isActive }) =>
        `block w-full px-3 py-2 rounded-lg transition-colors ${
            isActive ? "bg-[#F7E7CE] text-[#102C26]" : "text-white hover:bg-[#1a453d]"
        }`;
      ...
      `}
        ...
        "
            ...
            <div className="flex flex-col gap-2">
                ...
                <NavLink to="/activities" className={navClass} onClick={() => setOpen(false)}>
                    <div className="flex items-center gap-2">
                        <Activity size={18} />
